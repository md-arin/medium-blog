    ...
    <div className=" border-b flex justify-between px-10 py-5 mb-4">
      ...
      <main className="flex-1">
        <section className="w-full py-12 md:py-24 lg:py-32 border-b">
          <div className="container flex flex-col items-center justify-center space-y-4 px-4 md:px-6">
            <div className="space-y-2 text-center">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Welcome to the write iT</h1>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container grid items-center gap-4 px-4 md:px-6 lg:gap-10">
            <div className="mx-auto space-y-4 text-center">
              ...
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Introducing the Acme Blog</h2>
              <p className="mx-auto max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                Dive into the world of the Acme Blog with our inaugural post. We're excited to share our thoughts, and
            ...
            <div className="mx-auto grid max-w-5xl items-start gap-4 px-4">
              ...
              <div className="grid gap-4 md:gap-8">
                ...
                <div className="space-y-2">
                  <p className="text-xl font-bold tracking-tight">Welcome to the Acme Blog</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Dive into the world of the Acme Blog with our inaugural post. We're excited to share our thoughts,
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container grid items-center gap-4 px-4 md:px-6 lg:gap-10">
            <div className="mx-auto space-y-4 text-center">
              <div className="inline-block rounded-lg bg-gray-100 px-3 py-1 text-sm dark:bg-gray-800">Featured</div>
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">The Best of the Acme Blog</h2>
              <p className="mx-auto max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                Dive into the world of the Acme Blog with our inaugural post. We're excited to share our thoughts, and
                we can't wait to hear yours.
              </p>
            ...
            <div className="mx-auto grid max-w-5xl items-start gap-4 px-4">
              <ul className="grid gap-6">
                <li className="grid gap-1">
                  <h3 className="text-xl font-bold">Welcome to the Acme Blog</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Dive into the world of the Acme Blog with our inaugural post. We're excited to share our thoughts,
                    and we can't wait to hear yours.
                  </p>
